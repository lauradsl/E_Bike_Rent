...
public class FavoritoController {
    ...
    @Operation(summary = "Listado de todos los productos favoritos")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Listado de productos favoritos obtenido correctamente",
                    content = {@Content(mediaType = "application/json",
